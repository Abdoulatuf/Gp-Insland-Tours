...
$sql = "SELECT * FROM circuit WHERE page = 'patrimoine'";
$stmt = $db->prepare($sql);
$stmt->execute();
...
<main class="main">
    <section class="hero section dark-background">
        <img src="assets/img/patrimoine.jpeg" alt="" data-aos="fade-in">
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            <h2 class="text-center mt-4">Patrimoine</h2>
            <p class="text-center">Découvrez l'histoire et le patrimoine culturel des Comores.</p>
