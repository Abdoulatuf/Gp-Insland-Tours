...
$sql = "SELECT * FROM circuit WHERE page = 'montagne'";
$stmt = $db->prepare($sql);
$stmt->execute();
...
<main class="main">
    <section class="hero section dark-background">
        <img src="assets/img/montagne.jpeg" alt="" data-aos="fade-in">
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            <h2 class="text-center mt-4">Montagne</h2>
            <p class="text-center">Découvrez les paysages majestueux des montagnes des Comores.</p>
            ...
            <div class="row mt-5" data-aos="fade-up" data-aos-delay="200">
                <?php if (!empty($circuits)) : ?>
                    ...
                    <?php endforeach; ?>
                <?php else : ?>
                    <p class="text-center">Aucun circuit montagne disponible pour le moment.</p>
                <?php endif; ?>
            </div>
        </div>
    </section>
