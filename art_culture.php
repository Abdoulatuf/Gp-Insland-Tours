...
$sql = "SELECT * FROM circuit WHERE page = 'art_culture'";
$stmt = $db->prepare($sql);
$stmt->execute();
...
<main class="main">
    <section class="hero section dark-background">
        <img src="assets/img/art&culture.jpg" alt="" data-aos="fade-in">
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            <h2 class="text-center mt-4">Arts & Culture</h2>
            <p class="text-center">Plongez-vous dans l'univers artistique et culturel des Comores.</p>
